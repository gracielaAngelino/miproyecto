...
class Invoice{
	...
	public function saveInvoice($POST) {		
		$sqlInsert = "
			...
			VALUES ('".$POST['userId']."', '".$POST['cliente']."', '".$POST['address']."', '".$POST['subTotal']."', '".$POST['taxAmount']."', '".$POST['taxRate']."', '".$POST['totalAftertax']."', '".$POST['amountPaid']."', '".$POST['amountDue']."', '".$POST['notes']."')";		
	...
	public function updateInvoice($POST) {
		if($POST['invoiceId']) {	
			$sqlInsert = "
				...
				SET order_receiver_name = '".$POST['cliente']."', order_receiver_address= '".$POST['address']."', order_total_before_tax = '".$POST['subTotal']."', order_total_tax = '".$POST['taxAmount']."', order_tax_per = '".$POST['taxRate']."', order_total_after_tax = '".$POST['totalAftertax']."', order_amount_paid = '".$POST['amountPaid']."', order_total_amount_due = '".$POST['amountDue']."', note = '".$POST['notes']."' 
