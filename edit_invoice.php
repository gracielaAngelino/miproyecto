...
if(!empty($_POST['cliente']) && $_POST['cliente'] && !empty($_POST['invoiceId']) && $_POST['invoiceId']) {	
    ...
    <a>San Joaquín - Estado Carabobo</a><br>		      						      									
		      		...
		      		<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 pull-right">
		      			...
		      			<div class="form-group">
							<input value="<?php echo $invoiceValues['order_receiver_name']; ?>" type="text" class="form-control" name="cliente" id="cliente" placeholder="Nombre de Empresa" autocomplete="off">
						</div>
						<div class="form-group">
...
<tr>
    ...
    <td><input type="text" value="<?php echo $invoiceItem["order_item_quantity"]; ?>" name="quantity[]" id="quantity_<?php echo $count; ?>" class="form-control" autocomplete="off"></td>
